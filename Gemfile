...
gem 'spree_social', github: 'spree-contrib/spree_social', branch: '2-3-stable'
...
gem 'spree_recently_viewed', github: 'spree-contrib/spree_recently_viewed', branch: '2-3-stable'
gem 'spree_related_products', github: 'spree-contrib/spree_related_products', branch: '2-3-stable'
